...
/**
 * Generates a realistic fake transaction reference ID based on payment method
 * e.g. TELEBIRR-QK892X14, MPESA-TRX9901A, CBEBIRR-88129031
 */
export function generateFakeTransactionId(methodId = 'telebirr') {
