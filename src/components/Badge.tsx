...
export type BadgeType = 'primary' | 'critical' | 'medium' | 'low' | 'donor' | 'hospital';
...
export default function Badge({ label, type = 'primary', size = 'medium', style, textStyle }: BadgeProps) {
  const getColors = () => {
    switch (type) {
      case 'critical':
