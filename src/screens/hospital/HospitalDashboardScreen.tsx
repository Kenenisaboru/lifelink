...
import type { HospitalDashboardScreenProps } from '../../types/navigation';
import type { HospitalUser } from '../../types';

export default function HospitalDashboardScreen({ navigation }: HospitalDashboardScreenProps) {
  const { user, logout } = useAuthStore();
  const { requests, getActiveRequests, getFulfilledRequests } = useRequestStore();
      ...
      <View style={styles.topHeader}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.hospitalName} numberOfLines={1}>
            {hospitalUser?.hospitalName || 'Nairobi Emergency Hospital'}
          </Text>
        </View>
