...
import type { ResponseTrackerScreenProps } from '../../types/navigation';

export default function ResponseTrackerScreen({ route, navigation }: ResponseTrackerScreenProps) {
  const { requestId } = route.params || {};
  const { getRequestById, markFulfilled, loading } = useRequestStore();
